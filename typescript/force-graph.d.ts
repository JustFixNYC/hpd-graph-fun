declare module "force-graph" {
  // Ideally the typings for NodeObject and LinkObject would be generic, so we
  // could add our own custom fields, but the ones in @types/force-graph aren't,
  // so we're just forking them here.
  ...
  function ForceGraph(): ForceGraphInstance;
